/**
 ...
 \brief  Class to be used for an array of n strings. Adapted from NOMAD 4 ArrayOfString
 \author Viviane Rochon Montplaisir
 \date   February 2018
 \see    ArrayOfString.cpp
 */

#ifndef __ARRAYOFSTRING__
#define __ARRAYOFSTRING__
